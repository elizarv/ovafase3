...
if (tiAval){parent.iniciaActividade()}$("#goLeftBut").mousedown(function(e) {e.preventDefault();changeTag(-1);});$("#goRightBut").mousedown(function(e) {e.preventDefault();changeTag(1);});}
...
if (ima[indexTag].length>0){$("#ardoraChecks").css("width","575");
