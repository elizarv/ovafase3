...
<link type="text/css" href="inPanel16062019224954_resources/css/ardoraPanel.css" rel="stylesheet" />
<script language="javascript" type="text/javascript" src="inPanel16062019224954_resources/js/jquery.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019224954_resources/js/jquery-ui.min.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019224954_resources/js/jquery.ui.touch-punch.min.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019224954_resources/js/ardoraPanelCFG.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019224954_resources/js/ardoraScorm.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019224954_resources/js/ardoraPanel.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019224954_resources/js/ardoraTab.js"></script>
      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h4><p>El restaurante "A su gusto" se esta preparando para convertirse en uno de los mejores de la ciudad, <br>por esta razón nombraron a todos sus clientes "críticos de comidas". <br>Un crítico de comidas puede realizar 3 acciones, probar comida, beber vino y pagar comida. <br>Dentro del restaurante existen varios chef, los cuales tienen sólo una acción a sucargo: preparar comida.
                <br><br>
              Escribe el caso de uso correspondiente al lugar indicado.</p></h4>
          </div>
          <div class="box-body">
            <div id="ardoraAct">
