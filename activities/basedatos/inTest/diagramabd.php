...
<link type="text/css" href="inTest16062019191704_resources/css/ardoraTest.css" rel="stylesheet" />
<script language="javascript" type="text/javascript" src="inTest16062019191704_resources/js/jquery.js"></script>
<script language="javascript" type="text/javascript" src="inTest16062019191704_resources/js/jquery-ui.min.js"></script>
<script language="javascript" type="text/javascript" src="inTest16062019191704_resources/js/jquery.ui.touch-punch.min.js"></script>
<script language="javascript" type="text/javascript" src="inTest16062019191704_resources/js/ardoraTestCFG.js"></script>
<script language="javascript" type="text/javascript" src="inTest16062019191704_resources/js/ardoraScorm.js"></script>
<script language="javascript" type="text/javascript" src="inTest16062019191704_resources/js/ardoraTest.js"></script>
<script language="javascript" type="text/javascript" src="inTest16062019191704_resources/js/ardoraTab.js"></script>
      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h4><p>Seleccione la respuesta o respuestas correctas según se le indique en el enunciado.</p></h4>
          </div>
          <div class="box-body">
