...
<link type="text/css" href="inPanel16062019230209_resources/css/ardoraPanel.css" rel="stylesheet" />
<script language="javascript" type="text/javascript" src="inPanel16062019230209_resources/js/jquery.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019230209_resources/js/jquery-ui.min.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019230209_resources/js/jquery.ui.touch-punch.min.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019230209_resources/js/ardoraPanelCFG.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019230209_resources/js/ardoraScorm.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019230209_resources/js/ardoraPanel.js"></script>
<script language="javascript" type="text/javascript" src="inPanel16062019230209_resources/js/ardoraTab.js"></script>
      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h4><p>El sistema cuenta con 3 tipos de usuario:<br>un usuario autorizado que puede simplemente ingresar al sistema, <br>profesor y estudiante que pueden acceder al sistema y realizar diferentes tipos de acciones.<br>
A los profesores se les debe permitir registrar notas, actualizar notas, reportar notas por asignatura y reportar notas por estudiante.<br>
A los estudiantes se les permitirá ver notas por asignatura y ver notas por el estudiante.<br><br>
Escriba el caso de uno que iria en el lugar indicado segpun el enunciado anterior.
</p></h4>
          </div>
          <div class="box-body">
            <div id="ardoraMain">
